...
const images = {
				...
				const frontmatter = {"name":"Portfolio Website 🧮","description":"A website where I showcase my experiences and projects.","tech":"JavaScript, HTML & CSS, Astro","slug":"my-portfolio","isPublished":true,"isSelected":true};
				const file = "C:/Users/kadir/OneDrive/Documents/My Websites/kadirlofca.github.io/src/content/projects/01-portfolio-website.md";
				const url = undefined;
				function rawContent() {
